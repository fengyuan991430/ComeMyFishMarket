...
namespace ComeMyFishMarket.Controllers
{
    public class AppUsersController : Controller
    {
        ...
        public AppUsersController(ComeMyFishMarketClassContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,RegUserID,Username,Email,Role")] AppUser appUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,RegUserID,Username,Email,Role")] AppUser appUser)
        {
            if (id != appUser.ID)
            {
                return NotFound();
